...
const translations = {
  en: {
    ...
    kit_brigadeiro_desc: "Artisanal brigadeiros made with quality cocoa. Perfect for parties and special events. Portions of 20 units.",
    kit_beijinho_name: "🥥 Beijinho Kit",
    kit_beijinho_desc: "Fresh coconut beijinhos, soft and irresistible. Ideal to complete your dessert table. Portions of 20 units.",
  ...
  pt: {
    ...
    kit_brigadeiro_desc: "Brigadeiros artesanais feitos com cacau de qualidade. Perfeitos para festas e eventos especiais. Porções de 20 unidades.",
    kit_beijinho_name: "🥥 Kit Beijinho",
    kit_beijinho_desc: "Beijinhos de coco fresquinhos, suaves e irresistíveis. Ideais para completar sua mesa de doces. Porções de 20 unidades.",
  ...
  es: {
    ...
    kit_brigadeiro_name: "🍫 Kit Brigadeiro",
    kit_brigadeiro_desc: "Brigadeiros artesanales hechos con cacao de calidad. Perfectos para fiestas. Porciones de 20 unidades.",
    kit_beijinho_name: "🥥 Kit Beijinho",
    kit_beijinho_desc: "Beijinhos de coco frescos, suaves e irresistibles. Ideales para tu mesa de postres. Porciones de 20 unidades.",
